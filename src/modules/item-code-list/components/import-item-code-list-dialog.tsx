...
export function ImportItemCodeListDialog({
  ...
  const validCount = parsedData?.filter((r) => r._valid).length ?? 0
  const invalidCount = parsedData?.filter((r) => !r._valid).length ?? 0
      ...
      <DialogContent className="sm:max-w-[720px] max-h-[85vh] flex flex-col">
                        ...
                        <tr
                          ...
                          className={
                            row._valid
                              ...
                              : "border-b border-red-200 bg-red-50 dark:bg-red-950/20"
                          }
                        >
                          ...
                          <td className="px-2 py-1.5 truncate max-w-[120px]">
                            {row.MAVCode || <span className="text-red-400">-</span>}
                          </td>
        ...
        <DialogFooter>
          ...
          <Button
            ...
            disabled={!parsedData || validCount === 0 || isImporting}
            className="cursor-pointer"
          >
